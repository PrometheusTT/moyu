...
竹海、石桥、山门、大漠、雪岭、古塔循环出现；每三关有Boss，每九关由高阶剑宗替代蛛王；非Boss的第五关倍数出现剑客精英，同屏最多六只。
蛛王按关卡增加生命：第3/6关为5/7格，最高25格；剑客精英6～12格，高阶剑宗20～36格，分青锋突刺型与玄衣守反型。
剑客共享主角的持剑骨架与剑谱，有蓄势、格挡、突刺、回旋或落阵；红色剑气表示敌方攻击。
