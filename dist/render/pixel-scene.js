...
export function paintPixelWorld(c, world, context, previous, result = false) {
    ...
    c.rect(0, floorY, c.width, Math.max(1, Math.round(scale * 0.65)), ink(mix(palette.floor, palette.wave, flash * 0.45)));
